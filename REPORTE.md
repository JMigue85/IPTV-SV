...
**Última verificación:** 2026-09-22 20:47:40 UTC
...
| ClickTV [No24/7](Coronel - Biobío) [Opc.2] | 🔴 ERROR DE CONEXIÓN (servidor caído / DNS / rechazado) |
| TVN HD (LOCAL) | 🔴 HTTP 404 |
...
| Imagen Universal (Rep. Dominicana) | 🔴 HTTP 404 |
...
<details>
<summary><strong>Colombia</strong> (10 caídos)</summary>
...
| Canal del Futbol (Ecuador)[Opc.1] | 🔴 HTTP 404 |
...
| Telerama SD  [No 24/7] (Azuay / Nacional) | 🔴 HTTP 404 |
...
| Telemax (Argentina) | 🔴 TIMEOUT (no respondió a tiempo) |
...
<details>
<summary><strong>FOX Sports</strong> (3 caídos)</summary>
...
| Visión TV HD (Solola) | 🔴 HTTP 404 |
| Canal Sol TV HD | 🔴 HTTP 404 |
| TVS Retro TV (Solola) | 🔴 HTTP 404 |
...
| Canal 26 (Nacional) | 🔴 TIMEOUT (no respondió a tiempo) |
...
| MusicTop | 🔴 TIMEOUT (no respondió a tiempo) |
| Tierramia TV | 🔴 TIMEOUT (no respondió a tiempo) |
...
| Canal | Motivo |
|---|---|
| Pluto TV Aventura | 🔴 ERROR DE CONEXIÓN (servidor caído / DNS / rechazado) |
