...
**Última verificación:** 2026-09-16 10:41:31 UTC
...
**Total:** 1773 &nbsp;|&nbsp; **OK:** 1565 &nbsp;|&nbsp; **Caídos:** 208

<details>
<summary><strong>Anime</strong> (9 caídos)</summary>

| Canal | Motivo |
|---|---|
| Delmi TV | 🔴 HTTP 502 |
| Fun TV | 🔴 HTTP 404 |
| Anime Station (América Latina) [No 24/7] | 🔴 HTTP 502 |
| Cartoon Clasico | 🔴 HTTP 404 |
| Fun TV Este | 🔴 HTTP 404 |
| Bitme HD (México)[Opc.3] | 🔴 TIMEOUT (no respondió a tiempo) |
...
<details>
<summary><strong>Argentina</strong> (7 caídos)</summary>
...
| Chile Channel TV HD (Nacional) | 🔴 HTTP 404 |
...
| Pantalla Clásica [No 24/7] (Ecuador) | 🔴 HTTP 502 |
...
|---|---|
| FMH Family | 🔴 HTTP 404 |
| Cine Familiar HD (Opc.1) | 🔴 TIMEOUT (no respondió a tiempo) |
| Cine Premium HD (Opc.1) | 🔴 TIMEOUT (no respondió a tiempo) |
| Cine Hispano HD (Opc.1) | 🔴 TIMEOUT (no respondió a tiempo) |
| Azteca Cinema HD | 🔴 TIMEOUT (no respondió a tiempo) |
...
| RCN2 HD | 🔴 TIMEOUT (no respondió a tiempo) |
| Caracol HD [Opc.1] | 🔴 TIMEOUT (no respondió a tiempo) |
| Canal Calima TV HD (URESTV)[No 24/7] (Cali / Valle del Cauca) | 🔴 TIMEOUT (no respondió a tiempo) |
...
| TyC Sports AR | 🟡 *(posible falso positivo)* HTTP 403 |
...
| Azteca Deportes Network HD | 🔴 TIMEOUT (no respondió a tiempo) |
...
| Canal | Motivo |
|---|---|
| H2 SD | 🔴 TIMEOUT (no respondió a tiempo) |
...
| Canal 7 Salta (Salta / Argentina) | 🔴 HTTP 404 |
...
| Canal 24 Multivision [No 24/7](Bolivia) | 🔴 HTTP 502 |
...
| Azcorazon HD [Opc.3] | 🔴 TIMEOUT (no respondió a tiempo) |
...
<details>
<summary><strong>Fashion</strong> (1 caídos)</summary>
...
| Laika Channel (ES) | 🔴 HTTP 502 |
| Canal infantil | 🔴 TIMEOUT (no respondió a tiempo) |
| Disney Jr HD (Opc.3) | 🔴 TIMEOUT (no respondió a tiempo) |
| Disney Channel HD (Opc.3) | 🔴 TIMEOUT (no respondió a tiempo) |
...
<details>
<summary><strong>Perú</strong> (14 caídos)</summary>
...
| Canal | Motivo |
|---|---|
| Sony HD (Opc.3) | 🔴 TIMEOUT (no respondió a tiempo) |
| Sony Movies HD [Opc.2] | 🔴 TIMEOUT (no respondió a tiempo) |

</details>

<details>
<summary><strong>TV Chichicasteca</strong> (7 caídos)</summary>
...
<details>
<summary><strong>Tigo Sports / Fox</strong> (4 caídos)</summary>
...
| Win Sports HD | 🔴 TIMEOUT (no respondió a tiempo) |
